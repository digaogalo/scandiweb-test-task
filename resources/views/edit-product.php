    ...
    <center>
        <div class="card-edit">
            ...
            <input type="text" class="fake-input" placeholder="Edit name" id="name" name="Name"
               value="<?= $product->Name ?>" oninvalid="this.setCustomValidity('Please, submit required data')"
               oninput="this.setCustomValidity('')" required><br>
            <input type="text" class="fake-input" placeholder="Edit price" pattern="[0-9]+" min="0"
               ...
               value="<?= $product->Price ?>" oninvalid="this.setCustomValidity('Please, submit required data')"
               oninput="this.setCustomValidity('')" required><br>
            ...
            <input type="text" class="fake-input" placeholder="Edit attribute" id="productAttribute"
               ...
               value="<?= $product->productAttribute ?>" oninvalid="this.setCustomValidity('Please, submit required data')"
               oninput="this.setCustomValidity('')" required><br>
         </div>
     </center>
